...
Run with::
    ...
    python -m frappe_runtime.server
...
from frappe_runtime.auth import close_clients
...
def load_handlers(sites_path: str | None = None) -> None:
	...
	import frappe_runtime.handlers
	from frappe_runtime.registry import discover_app_handlers
